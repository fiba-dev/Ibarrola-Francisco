...
export const MenuToggle = ({ toggle }: any) => (
	<button onClick={toggle} className="botonBurger">
...
function Button(props: any) {
	return <button className="root">{props.children}</button>;
}
function DesktopIcon(props: any) {
	return (
		<a className="desktop__button" href={props.href} onClick={props.onClick}>
			{props.children}
		</a>
	);
}
function MobileIcon(props: any) {
	return (
		<a className="mobil__button" onClick={props.onClick} href={props.href}>
			{props.children}
		</a>
	);
}
function HomeButton(props: any) {
	return (
		<a className="home__button" onClick={props.onClick} href={props.href}>
			{" "}
...
function BurgerButton(props: any) {
	return (
		<a className="burger__button" onClick={props.onClick} href={props.href}>
			{" "}
			<svg
				viewBox="0 0 32 32"
...
function GithubButton(props: any) {
	return (
		<a onClick={props.onClick} href={props.href} target={props.target}>
			<svg viewBox="0 0 30 30" className="github__button">
				{" "}
...
function LinkedinButton(props: any) {
	return (
		<a onClick={props.onClick} href={props.href} target={props.target}>
			<svg viewBox="0 0 50 50" className="linkedin__button">
				{" "}
